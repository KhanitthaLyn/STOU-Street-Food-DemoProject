...
/**
 * Application Lifecycle Listener implementation class startResource
 *
 */
@WebListener
public class startResource implements ServletContextListener, ServletContextAttributeListener, HttpSessionListener, HttpSessionAttributeListener, HttpSessionActivationListener, HttpSessionBindingListener, HttpSessionIdListener, ServletRequestListener, ServletRequestAttributeListener, AsyncListener {
    ...
    public void contextInitialized(ServletContextEvent sce)  { 
    	System.out.println("Loading resource on startup from webListener");
		DataConnection dc = DataConnection.connect("123");
		if(dc != null)
		{
			System.out.println("Customer and Food Service Open");
			customerservice = dc.getCustomerservice();
			foodservice = dc.getFoodservice();
			
			ServletContext sc = sce.getServletContext();
			sc.setAttribute("customerservice", customerservice);
			sc.setAttribute("foodservice", foodservice);
